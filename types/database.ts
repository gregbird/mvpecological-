...
export type Database = {
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          email: string;
          full_name: string;
          role: "admin" | "senior_ecologist" | "field_ecologist" | "gis_specialist" | "junior_ecologist" | "client";
    ...
    Enums: {
      ...
      health_status: "on_track" | "at_risk" | "overdue";
      user_role: "admin" | "senior_ecologist" | "field_ecologist" | "gis_specialist" | "junior_ecologist" | "client";
