          ...
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">Designated Sites</p>
              </div>
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                <p className="text-2xl font-bold">
                  {savedFindings.filter((f) => f.dataType === "species_record").length}
                </p>
                <p className="text-sm text-muted-foreground">Species Records</p>
              </div>
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                <p className="text-2xl font-bold">
                  {savedFindings.filter((f) => f.metadata?.isProtected).length}
                </p>
                <p className="text-sm text-muted-foreground">Protected Species</p>
              </div>
            </div>
          </CardContent>
        </Card>
