...
const workflowPhases = [
  ...
  },
  {
    ...
    icon: Search,
    steps: [
      { number: 2, label: 'Data Gathering', icon: Search },
      { number: 3, label: 'Desk Assessment', icon: FileText },
    ],
  },
  {
    id: 'field-research',
    ...
    icon: FlaskConical,
    steps: [{ number: 4, label: 'Field Research', icon: Clipboard }],
  },
  {
    id: 'reporting',
    label: 'Reporting',
    icon: BarChart3,
    steps: [
      { number: 5, label: 'Data Analysis', icon: BarChart3 },
      { number: 6, label: 'AI Draft', icon: Sparkles },
      { number: 7, label: 'Quality Review', icon: CheckCircle },
      { number: 8, label: 'Final Submission', icon: CheckCircle },
    ],
  },
]
